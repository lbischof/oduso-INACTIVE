    	...
    	$.ajax({
    		...
    		success: function(data){
    			...
    			if (navigator.appVersion.indexOf("Linux") === -1) 
    				$('#generatedIcons').before(navigator.appVersion.indexOf("Linux"));//"<p>It looks like you aren't using Linux. You can email the script to yourself or save to Dropbox.</p>");
